...
namespace Ticari_Otomasyon
{
    public partial class FrmNotlar : Form
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(TxtBaslik.Text) || string.IsNullOrWhiteSpace(RchDetay.Text) || string.IsNullOrWhiteSpace(MskTarih.Text) || string.IsNullOrWhiteSpace(MskSaat.Text) || string.IsNullOrWhiteSpace(TxtHitap.Text) || string.IsNullOrWhiteSpace(TxtOlusturan.Text))
            {
