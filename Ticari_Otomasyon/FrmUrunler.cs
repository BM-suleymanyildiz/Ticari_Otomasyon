...
namespace Ticari_Otomasyon
{
    public partial class FrmUrunler : Form
    {
        ...
        {
            int yil = Convert.ToInt32(MskYil.Text);
            if (TxtAd.Text == "" || TxtMarka.Text == "" || TxtModel.Text == "" || MskYil.Text == "" || yil < 2010 || NudAdet.Value <= 0 || TxtAlis.Text == "" || TxtSatis.Text == "")
            {
                MessageBox.Show("Lütfen Boş Alan Bırakmayınız, Adet 0'dan büyük olmalıdır ve yıl değeri 2009 üzeri olmalıdır.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            if (TxtAd.Text == "" || TxtMarka.Text == "" || TxtModel.Text == "" || MskYil.Text == "" || NudAdet.Value == 0 || TxtAlis.Text == "" || TxtSatis.Text == "")
            {
